    ...
    return(
        ...
        <section className="bg-banner w-full h-720 flex justify-end items-center p-14">
            <div className="bg-marromCard h-card w-card rounded-lg p-10">
                ...
                <h1 className=" font-montserrat text-marromTexto text-6xl font-bold  leading-tight w-559">Discover our new Collection</h1>
                ...
                <button className="p-6 mt-11 font-bold font-poppins pr-20 pl-20 align-middle bg-marromTexto text-white">BUY NOW</button>
            </div>    
        </section> 
